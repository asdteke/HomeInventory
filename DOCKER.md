...
This guide targets the public v2.6.2 release line and later patch releases. Docker upgrades should rebuild the image rather than only restarting an old container.

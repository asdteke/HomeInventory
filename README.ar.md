...
> [!NOTE]
> **الإصدار v2.2.0 هو خط الإصدار الحالي.** يتضمن التقاط الصور بالكاميرا المحمولة للعناصر والفواتير، وتنظيف عميل TypeScript، وتحسين موثوقية الواجهة وإمكانية الوصول، والتخزين المؤقت/الضغط في الإنتاج، ولقطات شاشة محدثة، وحزم المشغل لأنظمة macOS وWindows وLinux، وإصلاحات أمان لـ React Router و`shell-quote`.

...
> [!NOTE]
> **الإصدار v2.2.0 هو إصدار صيانة أمنية.** يعالج تنبيه npm الحرج المفتوح الخاص بـ `shell-quote`، ويحافظ على دعم الكاميرا/الصور المحمولة من v2.1.3، ويوثق حالة Tauri/GLib المتبقية من المنبع للمشغل الاختياري على Linux.

...
> [!NOTE]
> **يوفر الإصدار v2.1.3 دعمًا أصليًا لالتقاط الصور بواسطة الكاميرا المحمولة.** يضيف هذا الإصدار تكاملاً مباشرًا مع كاميرا الجهاز (`capture="environment"`) لرفع صور العناصر والفواتير، مع الحفاظ على ميزة تحديد الملفات من الاستوديو/المعرض، وضمان تكامل الترجمات بنسبة 100% لجميع اللغات المدعومة التي تتجاوز الـ 100 لغة.

...
> [!NOTE]
> **الإصدار v2.5.2 هو خط الإصدار الحالي.** يحافظ على ميزات v2.5.1، ويحدّث `sharp` وبيئة libvips المضمّنة لمعالجة أحدث تنبيه أمني، ويحافظ على تطابق إصدار التطبيق المُدار ومشغّل سطح المكتب.

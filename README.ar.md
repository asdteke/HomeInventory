...
<details>
<summary><strong>لقطات إضافية: المخزون، الصناديق، محتويات الصندوق، مركز الإعارة، الخزنة الشخصية، الفئات</strong></summary>
...
<p align="center">
  <img src="docs/assets/screenshot-boxes.png" alt="شاشة الصناديق" width="82%" />
</p>
<p align="center">
  <img src="docs/assets/screenshot-box-detail.png" alt="شاشة محتويات الصندوق" width="82%" />
</p>
<p align="center">
  <img src="docs/assets/screenshot-borrow.png" alt="شاشة مركز الإعارة" width="82%" />
</p>
<p align="center">
  <img src="docs/assets/screenshot-vault.png" alt="شاشة الخزنة الشخصية" width="82%" />
</p>
<p align="center">
...
> [!NOTE]
> **الإصدار v2.6.1 هو خط الإصدار الحالي.** يحافظ على إدارة الصناديق في v2.6، ويحسّن كاميرا مسح الباركود وQR على الهاتف، ويجعل البحث الخارجي عن المنتجات اختياريًا بموافقة المستخدم، ويصقل واجهات البداية وتسجيل الدخول، ويبقي التطبيق المُدار ومشغّل سطح المكتب متطابقين.
...
| الصناديق | صناديق مشتركة أو شخصية، إسناد عنصر واحد أو عدة عناصر، صور بالكاميرا أو المعرض، اختيار الغرفة وإنشاء الموقع ضمن التدفق نفسه، نقل وحذف محميان، وطباعة ملصقات QR |
...
- **خصوصية مستقلة للصناديق والعناصر** تسمح للصندوق المشترك باحتواء عناصر خاصة لكل عضو من دون كشفها في عروض الجرد العادية، بينما تبقى الصناديق الشخصية ومواقعها الدقيقة مرئية لمنشئها فقط.

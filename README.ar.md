...
> [!NOTE]
> **الإصدار v2.6.0 هو خط الإصدار الحالي.** يضيف إدارة بسيطة للصناديق المشتركة والشخصية مع نقل آمن للعناصر وملصقات QR ونسخ احتياطية متوافقة، مع الحفاظ على تحديثات الأمان وتطابق الإصدارات.

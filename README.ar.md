...
> [!NOTE]
> **الإصدار v2.2.0 هو خط الإصدار الحالي.** يغلق تنبيه npm الحرج الخاص بـ `shell-quote`، ويوحّد بيانات الإصدار والوثائق، وينشر حزم المشغل التي تم التحقق منها، ويوثق حالة Tauri/GLib المتبقية من المنبع. توجد أعمال الكاميرا المحمولة وTypeScript والواجهة في أقسام v2.1.x السابقة من سجل التغييرات.

...
> [!NOTE]
> **الإصدار v2.5.1 هو خط الإصدار الحالي.** يحسن الواجهات الأساسية، ويحدّث الاعتماديات المرتبطة بالأمان، ويحافظ على تطابق إصدار التطبيق المُدار ومشغّل سطح المكتب.

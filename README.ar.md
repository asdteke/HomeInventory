...
تم تطوير هذا المشروع بمساعدة أدوات الذكاء الاصطناعي (بما في ذلك Google Gemini و OpenAI GPT). تمت مراجعة واختبار والتحقق من جميع الأكواد المولّدة بالذكاء الاصطناعي من قبل المطور.

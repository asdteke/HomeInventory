...
> [!NOTE]
> **الإصدار v2.2.0 هو خط الإصدار الحالي.** ينشر حزم مشغل سطح المكتب التي تم التحقق منها، ويوثق تدفق المشغل الحالي من التهيئة والتشغيل إلى فتح المتصفح تلقائياً، ووصول QR/LAN، والسجلات، والنسخ الاحتياطي، والإعدادات، وفحوصات المنافذ، ويغلق تنبيه npm الحرج الخاص بـ `shell-quote`، ويوحّد بيانات الإصدار، ويسجل حالة Tauri/GLib المتبقية من المنبع.

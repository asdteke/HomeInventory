...
const PAGE_TITLES: PageTitleRoute[] = [
    ...
    { path: '/qr-labels', label: (t) => t('inventory.qr_labels.title', { defaultValue: 'QR labels' }) },
    { path: '/storage-labels', label: (t) => t('storage_labels.title', { defaultValue: 'Storage labels' }) },
    { path: '/notifications', label: (t) => t('navigation.notifications', { defaultValue: 'Notifications' }) },
    { path: '/service', label: (t) => t('navigation.service', { defaultValue: 'Service' }) },
    { path: '/activity', label: (t) => t('navigation.activity', { defaultValue: 'Activity' }) },
    { path: '/alerts/:type', label: (t) => t('navigation.notifications', { defaultValue: 'Alerts' }) },
    { path: '/maintenance', label: (t) => t('navigation.maintenance', { defaultValue: 'Maintenance Schedule' }) },
    { path: '/shopping', label: (t) => t('navigation.shopping', { defaultValue: 'Shopping List' }) },
    ...
    { path: '/organize/boxes/:id', label: (t) => t('navigation.boxes', { defaultValue: 'Boxes' }) },
    { path: '/organize/boxes', label: (t) => t('navigation.boxes', { defaultValue: 'Boxes' }) },
    { path: '/organize/rooms', label: (t) => t('navigation.rooms', { defaultValue: 'Rooms' }) },
    { path: '/organize/categories', label: (t) => t('navigation.categories', { defaultValue: 'Categories' }) },
    { path: '/organize', label: (t) => t('navigation.organization', { defaultValue: 'Organize' }) },

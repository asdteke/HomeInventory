...
export default function Login() {
    ...
    const dividerClass = isDark
        ? (false ? 'bg-[var(--hi-border)]' : 'bg-white/8')
                            ...
                            <div className="mt-8 sm:mt-9">
                                ...
                                {!requires2FA ? (
                                        ...
                                        <div className={`mt-8 border-t pt-5 ${isDark ? 'border-white/8' : 'border-[rgba(18,32,22,0.08)]'}`}>
                                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                                <p className={`text-sm ${panelMutedClass}`}>
                                                    ...
                                                    <Link to="/register" className={`font-semibold transition ${false ? 'text-[var(--hi-accent)] hover:text-[var(--hi-secondary-strong)]' : 'text-[#6f9978] hover:text-[#8bb395]'}`}>
                                    ...
                                    <form onSubmit={handleSubmit} noValidate className="space-y-5">
                                        ...
                                        <label className={`flex items-start gap-3 rounded-[var(--hi-radius-md)] border px-4 py-3 text-sm ${panelMutedClass} ${isDark ? (false ? 'border-[var(--hi-border)] bg-[rgba(24,31,44,0.72)]' : 'border-white/8 bg-white/[0.02]') : 'border-[rgba(18,32,22,0.08)] bg-[rgba(255,255,255,0.52)]'}`}>
                                            <input
                                                type="checkbox"

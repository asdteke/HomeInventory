...
export function NoticeBanner({ icon: Icon, title, description, tone = 'info', action, className = '' }) {
...
export function EmptyState({ icon: Icon, title, description, actions, tips = [], align = 'center', className = '' }) {
    return (

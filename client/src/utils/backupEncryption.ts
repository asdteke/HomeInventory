...
export function isEncryptedBackupPayload(payload: any): payload is BackupPayload {
    return payload?.kind === 'homeinventory-backup' && payload?.encrypted === true;
}

export async function encryptBackupPayload(payload: any, passphrase?: string): Promise<BackupPayload> {
...
export async function decryptBackupPayload(payload: any, passphrase?: string): Promise<any> {

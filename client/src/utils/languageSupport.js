export const PRODUCT_LANGUAGE_OPTIONS = [
...
export const SUPPORTED_PRODUCT_LANGUAGE_CODES = PRODUCT_LANGUAGE_OPTIONS.map((option) => option.code);

export function resolveSupportedLanguageCode(lang, fallbackCode = 'en') {
    if (!lang) {
        return fallbackCode;
    }
